...
public class ReturnedBooks extends javax.swing.JFrame {
    ...
    ResultSet rs;
    String query;
    String sn,name, matric, isbn,title,address, date, date2,datee,edt,subj1,user,pass;
    ...
    public ReturnedBooks() {
        ...
        this.setResizable(false);
          ...
          try{
            ...
            ResultSet rs = st.executeQuery("select * from Book_vw_Table");
           ...
           connect.close();
            ...
            Connection connect = DriverManager.getConnection(url);
            Statement st = connect.createStatement();
            rs = st.executeQuery("select * from ReturnBook_vw_Table order by Call_No ASC");
            ...
            while(rs.next()){
                    ...
                    date=rs.getString("IssuedOn");
                    date2=rs.getString("ReturnDate");
                    Object[] row = {name,title,isbn, matric,address, date, date2};
                    model.addRow(row);
            ...
            ResultSet rs2 = st2.executeQuery("select count(*) from ReturnBook_vw_Table");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Returned Book Details");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NAME", "BOOK TITLE", "CALL NO", "PHONE", "ADDRESS", "ISSUE DATE", "RETURN DATE"
            }
        ) {
        ...
        jPanel1.add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, 140, 30));

        jLabel5.setFont(new java.awt.Font("Perpetua", 1, 18)); // NOI18N
        jLabel5.setText("Serach by Call No :");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 160, 30));
        ...
        jPanel1.add(F_user4, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 180, 110, 30));
        ...
        jPanel1.add(lblDel, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 180, 80, 30));
        ...
        jPanel1.add(btnGEN, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 580, 170, 30));
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
            ...
            Connection connect = DriverManager.getConnection(url);
            Statement st = connect.createStatement();
             rs = st.executeQuery("select * from ReturnBook_vw_Table where Call_No='"+c1.getSelectedItem()+"' order by Call_No ASC");
    ...
    private void lblDelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblDelMouseClicked
        ...
        if(SelectedRowIndex >= 0){
            ...
            try
            {
                Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
                String url = "jdbc:sqlserver://localhost:1433; database=Trinity_DB; user=sa; password=Tunani14real;";
                Connection connect = DriverManager.getConnection(url);String sql = "delete from Return_Table where Call_No= ?";
                ...
                if(DialogButton == JOptionPane.YES_OPTION){
                    ...
                    ReturnedBooks info = new ReturnedBooks();
    ...
    private void btnFilter1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilter1ActionPerformed
        ...
        try
        {
            ...
            Connection connect = DriverManager.getConnection(url);
            Statement st = connect.createStatement();
            String sql = "select * from ReturnedBook_vw_Table where IssueDate between ? and ? order by Call_No ASC";
            ...
            if(rs.next())
            {
                ...
                address=rs.getString("Address");
                date=rs.getString("IssuedOn");
                datee=rs.getString("ReturnDate");
                Object[] row = {name,title,isbn,matric,address, date,datee};
                model.addRow(row);
    ...
    private void btnGENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGENActionPerformed
        ...
        if(SelectedRowIndex >= 0){
            ...
            try
            {
                ...
                String url = "jdbc:sqlserver://localhost:1433; database=Trinity_DB; user=sa; password=Tunani14real;";
                Connection connect = DriverManager.getConnection(url);
                String sql = "Select * from ReturnedBook_vw_Table where Call_No= ?";
                PreparedStatement stmt = connect.prepareStatement(sql);
                stmt.setString( 1, selected );
                ...
                if(DialogButton == JOptionPane.YES_OPTION){
                    ...
                    matric=rs.getString("Phone_No");
                    address=rs.getString("Address");
                    subj1=rs.getString("Subject");
                    date=rs.getString("IssuedOn");
                    datee=rs.getString("ReturnDate");
                    }
                    ReturnPrint info = new ReturnPrint();
                    ReturnPrint.lblFull.setText(name);
                    ReturnPrint.lblUse.setText(user);
                    ReturnPrint.lblTit.setText(title);
                    ReturnPrint.lblCall.setText(isbn);
                    ReturnPrint.lblpas.setText(pass);
                    ReturnPrint.lblFon.setText(matric);
                    ReturnPrint.lblAdd.setText(address);
                    ReturnPrint.lblCos.setText(subj1);
                    ReturnPrint.lblISU.setText(date);
                    ReturnPrint.lblDate.setText(datee);
                    info.setVisible(true);
                    this.dispose();
                }else{
